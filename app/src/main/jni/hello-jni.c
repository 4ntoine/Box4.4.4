...
Java_com_example_mono_box444_MainActivity_Replace( JNIEnv* env, jobject thiz, jobject appThread ) {
    ...
    jfieldID id = (*env)->GetStaticFieldID(env, cls, "ONE_COUNT_COLUMN", "Ljava/lang/String;");
    jstring str = (*env)->GetStaticObjectField(env, cls, id);
    jmethodID mid = (*env)->GetMethodID(env, cls, "scheduleSuicide", "()V");
